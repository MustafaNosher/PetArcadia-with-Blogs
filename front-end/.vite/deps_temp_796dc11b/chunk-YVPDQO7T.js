...
function createGrid(options = {}) {
  ...
  const Grid2 = React8.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow = React8.useContext(OverflowContext);
    const {
      className,
      children,
...
var React8, import_prop_types5, import_jsx_runtime3, _excluded6, defaultTheme, defaultCreateStyledComponent;
...
var import_prop_types6, Grid, Grid_default;
var init_Grid = __esm({
  "node_modules/@mui/system/esm/Unstable_Grid/Grid.js"() {
    "use client";
...
@mui/styled-engine/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YVPDQO7T.js.map
